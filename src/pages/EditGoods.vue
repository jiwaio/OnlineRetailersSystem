<template>
  <div class="edit-goods">
    ...
    <!-- 卡片视图  -->
    <el-card>
      <el-alert title=修改商品信息 type="info" center show-icon style="margin: 5px 0">
      </el-alert>
...
export default {
  ...
  methods: {
    async getGoods_cat() {
      //根据当前的 $router 的内容获取参数
      let res1 = await this.axios.get(`goods/${this.$route.params.id}`)
      const form = _.cloneDeep(res1.data)
      form.goods_cat = form.goods_cat.split(",")
      // form.goods_cat
